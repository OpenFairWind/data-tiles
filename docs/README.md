...
| [Direct NetCDF demo](../demo/netcdf-archive/README.md) | checksum-locked Meteo@UniParthenope archive acquisition, configured variable allowlist, application launch, discovery, and DNT1 retrieval |
