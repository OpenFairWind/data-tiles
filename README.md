...
A complete runnable example, including checksum-locked Meteo@UniParthenope acquisition, archive discovery, server launch, and DNT1 retrieval, is available in [`demo/netcdf-archive`](demo/netcdf-archive/README.md).
