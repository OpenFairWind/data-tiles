...
- `figures/branding-theme.svg` — administrator branding inputs, allowlisted Bootstrap theme validation, normalized logo persistence, and the explicit boundary from scientific DataTiles content.
...
- `images/store-configuration.jpg` — administrator-only Store identity, uploaded-logo controls, and validated Bootstrap theme configuration.
...
![Administrator branding and theme configuration](images/store-configuration.jpg)
