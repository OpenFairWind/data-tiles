...
- [Served DataTiles catalogue browsing and map preview](served-preview.md)
- [Authentication and registration](authentication.md)
- [SMTP and email verification](smtp.md)
- [Store and catalog management](management.md)
- [Payments and commerce](payments.md)
- [Versioning, user library, and updates](versioning-and-updates.md)
- [Licence and safety agreements](agreements.md)
- [REST API](api.md)
...
Production operators should read the configuration, security, agreements, payment, and served-preview sections before exposing a Store to the Internet. DataTiles data licences remain independent of the Apache-2.0 Store software licence.
