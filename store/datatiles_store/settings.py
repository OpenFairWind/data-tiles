...
SETTINGS = [
 ...
 SettingDef("auth.google.allowed_domains","","Google","Allowed Google Workspace domains","",False,"Comma-separated; blank permits any verified Google email."),
 ...
 SettingDef("store.public_base_url","","Store","Public base URL","",False,"Required for reliable email/OIDC callbacks behind proxies."),
 ...
 SettingDef("commerce.provider","paypal","Commerce","Payment provider","",False,"Provider adapter name; reference implementation supplies PayPal."),
 ...
 SettingDef("payments.paypal.mode","sandbox","PayPal","PayPal mode","",False,"sandbox or live"),
