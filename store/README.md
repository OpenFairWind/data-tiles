...
Change the administrator password and `SECRET_KEY` before deployment. Payment is disabled by default. PayPal Orders v2 is the reference adapter and starts in sandbox mode when enabled.
