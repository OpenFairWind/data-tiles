...
# Browser-visible base URL of the high-performance DataTiles Online Delivery server.
# Empty disables served catalogue/map previews while preserving all Store functions.
TILE_SERVER_URL = os.environ.get("DATATILES_STORE_TILE_SERVER_URL", "").rstrip("/")
